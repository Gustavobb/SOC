...
module niosLab2_mm_interconnect_0 (
		...
		input  wire        peripheral_LED_0_reset_reset_bridge_in_reset_reset, // peripheral_LED_0_reset_reset_bridge_in_reset.reset
	...
	wire  [18:0] peripheral_led_0_avalon_slave_0_1_agent_m0_address;                                 // peripheral_LED_0_avalon_slave_0_1_agent:m0_address -> peripheral_LED_0_avalon_slave_0_1_translator:uav_address
	...
	wire  [95:0] peripheral_led_0_avalon_slave_0_1_agent_rf_source_data;                             // peripheral_LED_0_avalon_slave_0_1_agent:rf_source_data -> peripheral_LED_0_avalon_slave_0_1_agent_rsp_fifo:in_data
	...
	wire  [95:0] peripheral_led_0_avalon_slave_0_1_agent_rsp_fifo_out_data;                          // peripheral_LED_0_avalon_slave_0_1_agent_rsp_fifo:out_data -> peripheral_LED_0_avalon_slave_0_1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> peripheral_LED_0_avalon_slave_0_1_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                              // peripheral_LED_0_avalon_slave_0_1_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [4:0] cmd_mux_001_src_channel;                                                            // cmd_mux_001:src_channel -> peripheral_LED_0_avalon_slave_0_1_agent:cp_channel
	...
	wire  [94:0] peripheral_led_0_avalon_slave_0_1_agent_rp_data;                                    // peripheral_LED_0_avalon_slave_0_1_agent:rp_data -> router_003:sink_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                                            //                      clk.clk
		.reset                  (peripheral_LED_0_reset_reset_bridge_in_reset_reset),       //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                                      //             clk.clk
		.reset                   (peripheral_LED_0_reset_reset_bridge_in_reset_reset),                 //       clk_reset.reset
	...
	niosLab2_mm_interconnect_0_router_004 router_004 (
	...
	niosLab2_mm_interconnect_0_router_004 router_005 (
	...
	niosLab2_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	niosLab2_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                                // in_clk_0.clk
		.in_rst_0_reset (peripheral_LED_0_reset_reset_bridge_in_reset_reset),           // in_rst_0.reset
